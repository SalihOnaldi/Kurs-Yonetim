...
namespace SRC.Infrastructure.Migrations
{
    ...
    [Migration("20251120110011_AddDocumentFieldsAndCertificate")]
    partial class AddDocumentFieldsAndCertificate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SRC.Domain.Entities.Certificate", b =>
                {
                    ...
                    b.HasOne("SRC.Domain.Entities.Course", null)
                    ...
                    b.HasOne("SRC.Domain.Entities.Student", null)
                        .WithMany("Certificates")

    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MebGroups", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MebApprovalStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MebSessionCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CaptchaSolved = table.Column<bool>(type: "bit", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MebbisTransferJobs", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScheduleSlots_Users_InstructorId",
            ...
            migrationBuilder.CreateTable(
                name: "MebbisTransferItems",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MebbisTransferJobId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MebbisTransferItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MebbisTransferItems_Enrollments_EnrollmentId",
                        column: x => x.EnrollmentId,
                        principalTable: "Enrollments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MebbisTransferItems_MebbisTransferJobs_MebbisTransferJobId",
                        column: x => x.MebbisTransferJobId,
                        principalTable: "MebbisTransferJobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GpsLat = table.Column<decimal>(type: "decimal(18,10)", precision: 18, scale: 10, nullable: true),
                    GpsLng = table.Column<decimal>(type: "decimal(18,10)", precision: 18, scale: 10, nullable: true),
                    GpsAccuracy = table.Column<decimal>(type: "decimal(18,10)", precision: 18, scale: 10, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MebbisTransferItems_EnrollmentId",
                table: "MebbisTransferItems",
                column: "EnrollmentId");

            migrationBuilder.CreateIndex(
                name: "IX_MebbisTransferItems_MebbisTransferJobId",
                table: "MebbisTransferItems",
                column: "MebbisTransferJobId");

            migrationBuilder.CreateIndex(
                name: "IX_MebbisTransferJobs_CourseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleSlots_CourseId",
                table: "ScheduleSlots",
                column: "CourseId");
